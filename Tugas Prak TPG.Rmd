...
H0: Tidak ada perbedaan rata-rata vektor (berat, lemak) sebelum dan sesudah diet.

H1: Ada perbedaan rata-rata vektor (berat, lemak) sebelum dan sesudah diet.
...
t2_not_homogen
```
Karena p-value = 0.001735 < 0.05, maka H₀ ditolak. Artinya, terdapat perbedaan signifikan secara multivariat antara kelompok dengan durasi tidur lebih banyak (sleep_more) dan kelompok dengan durasi tidur lebih sedikit (sleep_less).
